...
export default function Navbar() {
    ...
    return (
        ...
        <nav className='flex items-center shadow-sm justify-between md:justify-around w-full gap-5 py-2 border-b-1 sticky top-0 border-gray-200  bg-white z-20 navbar-page'>
